...
## SQL Scripts for Beeckle Network Website
...
-- Sample Projects
INSERT INTO projects (title, slug, description, client, completion_date, images, tags) VALUES
('Corporate Website Redesign', 'corporate-website-redesign', 'Complete redesign of corporate website with modern UI/UX', 'Tech Corp', '2024-01-15', '{"/images/project1-1.jpg", "/images/project1-2.jpg"}', '{"web", "design", "corporate"}'),
('Mobile Banking App', 'mobile-banking-app', 'Secure mobile banking application with biometric authentication', 'Finance Bank', '2023-12-20', '{"/images/project2-1.jpg", "/images/project2-2.jpg"}', '{"mobile", "banking", "security"}'),
('Retail Security System', 'retail-security-system', 'Comprehensive security system for retail chain including CCTV and alarms', 'Retail Chain', '2023-11-30', '{"/images/project3-1.jpg", "/images/project3-2.jpg"}', '{"security", "cctv", "retail"}');

-- Sample Blog Posts
INSERT INTO blog_posts (title, slug, content, excerpt, author_id, published, published_at, cover_image) VALUES
('The Future of Web Development', 'future-web-development', 'Full blog content about web development trends...', 'Exploring the latest trends in web development and what they mean for businesses', '00000000-0000-0000-0000-000000000000', true, NOW(), '/images/blog1.jpg'),
('Cybersecurity Best Practices for 2024', 'cybersecurity-best-practices-2024', 'Comprehensive guide to cybersecurity...', 'Essential cybersecurity practices every business should implement', '00000000-0000-0000-0000-000000000000', true, NOW(), '/images/blog2.jpg');
